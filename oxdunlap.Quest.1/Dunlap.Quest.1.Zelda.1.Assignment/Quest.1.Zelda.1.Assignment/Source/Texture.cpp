...
void Texture::render(SDL_Renderer* renderer, GAME_VEC position, SDL_Rect* clip)
{
	//Set rendering space
...
void Texture::render(SDL_Renderer* renderer, GAME_VEC position, GAME_FLT angle, SDL_Rect* clip)
{
